...
- (void)viewDidLoad {
    ...
    [self.collectionView registerClass:[MenuCollectionCell class] forCellWithReuseIdentifier:@"collectionCell"];
}
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    MenuCollectionCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"collectionCell" forIndexPath:indexPath];
...
- (nullable UITargetedPreview *)collectionView:(UICollectionView *)collectionView previewForHighlightingContextMenuWithConfiguration:(UIContextMenuConfiguration *)configuration {
    MenuCollectionCell *cell = (MenuCollectionCell *)[collectionView cellForItemAtIndexPath:self.indexPath];
    if (cell == nil) {
        return nil;
    }
    if (self.indexPath.row < 2) {
